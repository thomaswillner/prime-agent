...
- Added `session patterns`, which reports deterministic rule-based patterns across saved sessions with the rule applied, the matching session count, and linked example sessions.
